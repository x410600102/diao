var js_src = {
    ...
    dev: [
        ...
        'js/dwz/dwz.panel.js',
        // 'js/dwz/dwz.project.js',
        'js/dwz/dwz.tabs.js',
        'js/dwz/dwz.slide.js',
        'js/dwz/dwz.slideTab.js',
        'js/dwz/dwz.filterSelect.js',
        'js/dwz/dwz.filterPanel.js',
        'js/dwz/dwz.daiolpanel.js',
        'js/dwz/dwz.technological.js',
        // 'js/dwz/dwz.customer.js',
        'js/dwz/dwz.gps.js',
        // 'js/dwz/dwz.amap.js',
        'js/dwz/dwz.bmap.js',
        'js/dwz/dwz.brush.js',
        ...
        'js/biz.transport.js',
        'js/biz.message.js',
        'js/biz.projectList.js',
        'js/biz.quotationList.js',
        'js/biz.Expandbutton.js',
		'js/biz.agentList.js',
        //'js/biz.favorite.js',
        'js/biz.my.js'
        //'js/biz.baiduFace.js'
...
function loadScripts(options) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        $.extend($.config, {
            ...
            statusCode: { ok: true, error: false, timeout: 301 },
            keys: { statusCode: 'IsSuccess', message: 'Message' }
        });
